var projects = [
  ...
  {
    title: "Bellabeat: análisis de hábitos de bienestar",
    type: "Caso de estudio Google Data Analytics",
    businessProblem: "Entender patrones de actividad, sueño y uso de dispositivos inteligentes con datos Fitbit para traducirlos en recomendaciones de marketing para Bellabeat.",
    process: "Limpieza reproducible con Python y pandas, análisis exploratorio, generación de visualizaciones, segmentación de usuarios y dashboard final en Power BI.",
    tools: ["Python", "Pandas", "Power BI", "EDA", "Fitbit", "Storytelling con datos"],
    outcome: "Análisis de 1,373 registros diarios de 35 usuarios, con hallazgos sobre pasos, sueño, segmentos de actividad y recomendaciones accionables de marketing.",
    tags: ["Python", "Pandas", "Power BI", "Bellabeat", "Fitbit", "EDA"],
    repoUrl: "https://github.com/Ulises-L0pez-Carpio/Caso-de-estudio-Google-analytics",
    liveUrl: "",
    dashboardUrl: "https://github.com/Ulises-L0pez-Carpio/Caso-de-estudio-Google-analytics/blob/main/dashboard/README.md",
    caseStudyUrl: "https://github.com/Ulises-L0pez-Carpio/Caso-de-estudio-Google-analytics/blob/main/reports/caso_estudio_bellabeat.md",
    previewImage: "",
